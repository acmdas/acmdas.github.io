...
“That which is true or certain concerning any matter or subject” depends on the subject. A true statement about gravity when the subject is Newtonian physics is false if the subject is switched to Einsteinean physics.

And, of course, “Righteousness; true religion” depends not only upon which religion, but which sect within a given religion.

So, it looks like, before we can get down and dirty with saying things that conform with reality, we may need to explore the various aspects of not-truth.
